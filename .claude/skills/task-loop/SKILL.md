---
name: task-loop
description: Drive a TASKS.md checklist to completion, one item at a time, gated by .claude/verify.sh. Use when asked to "work the task list", "run the loop", "finish the backlog", or when handed a multi-step job that should run unattended until done.
---
